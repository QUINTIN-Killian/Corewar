...
static int get_param_or(corewar_t *corewar, champion_t *champion, int ind,
    int pc_adding)
{
...
{
    int value1 = get_param_or(corewar, champion, 0, 2);
    int value2 = get_param_or(corewar, champion, 2, 3);
